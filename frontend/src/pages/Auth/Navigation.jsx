  ...
  return (
    ...
    className={`${showSidebar ? "hidden" : "flex"} xl:flex lg:flex md:hidden sm:hidden flex-col justify-between p-4 text-white bg-black w-[4%] hover:w-[15%] h-[100vh] fixed `}
      ...
      <div className="flex flex-col justify-center space-y-4 ">
        ...
        <Link to='/favarite' className='flex items-center transition-transform transform hover:translate-x-2 '>
      ...
      <div className="relative">
        ...
        {dropDownOpen && userInfo && (
          <ul className={`absoulte right-0 mt-2 mr-14 space-y-2 by-white text-gray-600 ${!userInfo.isAdmin ? '-top-20' : '-top-80'} `}>
            {userInfo.isAdmin && (
              <>
                <li>
